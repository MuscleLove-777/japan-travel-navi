...
tags: ['shrine', 'forest', 'tokyo', 'meiji']
categories: ["Temples"]
draft: false
...
cover:
  ...
  alt: "Meiji Jingu - Tokyo's Forest Shrine"
  hidden: false
slug: "meiji-jingu"
---
...
Meiji Jingu - Tokyo's Forest Shrine is one of Japan's most remarkable destinations, located in Tokyo. Step into the serene forest of Meiji Jingu, a Shinto shrine in the heart of Tokyo dedicated to Emperor Meiji.
...
The area surrounding Meiji Jingu is rich with history and cultural significance. Locals and tourists alike find themselves returning again and again, each visit revealing new details and perspectives that weren't noticed before.
