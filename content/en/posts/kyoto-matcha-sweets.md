...
tags: ['matcha', 'sweets', 'kyoto', 'green-tea']
categories: ["Food"]
draft: false
...
cover:
  ...
  alt: "Kyoto Matcha Sweets - Green Tea Heaven"
  hidden: false
...
Kyoto Matcha Sweets - Green Tea Heaven is one of Japan's most remarkable destinations, located in Kyoto. Indulge in Kyoto's finest matcha desserts from centuries-old tea houses to modern matcha cafes.
...
The area surrounding Kyoto Matcha Sweets is rich with history and cultural significance. Locals and tourists alike find themselves returning again and again, each visit revealing new details and perspectives that weren't noticed before.
