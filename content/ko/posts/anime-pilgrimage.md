...
cover:
  ...
  alt: "애니메이션 성지순례 가이드 - 실제 애니 배경지 방문"
  hidden: false
...
애니메이션 성지순례 가이드 - 실제 애니 배경지 방문은(는) 일본 각지에 위치한 일본을 대표하는 관광 명소 중 하나입니다. 『너의 이름은』의 스가신사부터 『센과 치히로의 행방불명』의 모델지까지. 애니 성지순례 가이드.
