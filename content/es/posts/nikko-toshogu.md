...
tags: ['santuario', 'tokugawa', 'nikko', 'ornamental']
categories: ["Templos"]
draft: false
...
cover:
  ...
  alt: "Nikko Toshogu - Santuario Ornamental en las Montañas"
  hidden: false
slug: "nikko-toshogu"
---
...
Nikko Toshogu - Santuario Ornamental en las Montañas es uno de los destinos más notables de Japón, ubicado en Tochigi. Admira Nikko Toshogu, el lujosamente decorado mausoleo de Tokugawa Ieyasu, enclavado en las montañas al norte de Tokio.
...
**En tren:** La forma más conveniente de llegar a Tochigi es en Shinkansen (tren bala) hasta la estación principal más cercana. Desde allí, trenes locales y autobuses proporcionan conexiones fáciles. Si tienes un JR Pass, la mayor parte del viaje estará cubierto.
...
Mientras estés en Tochigi, considera visitar estos otros lugares populares cercanos:
